 ...
 */
@Push
@PWA(name = "Movie Search", shortName = "Movie Search", enableInstallPrompt = false)
@Theme(themeFolder = "moviesearch")
@PageTitle("Main")
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        user.getStyle().set("margin-right","10px");
        layout.add(user);

        Avatar avatar = new Avatar();
        avatar.addClassNames("me-m");
        layout.add(avatar);
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Movie Search logo"));
        logoLayout.add(new H1("Movie Search"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("Movie list", "la la-list", MovielistView.class), //
                new MenuItemInfo("Favorites", "la la-star", FavoritesView.class), //
